...
import com.code_intelligence.jazzer.protobuf.Proto2.OptionalPrimitiveField2;
...
class BuilderMutatorProto2Test {
  ...
  void testOptionalPrimitiveField() {
    InPlaceMutator<OptionalPrimitiveField2.Builder> mutator =
        (InPlaceMutator<OptionalPrimitiveField2.Builder>) FACTORY.createInPlaceOrThrow(
            new TypeHolder<OptionalPrimitiveField2.@NotNull Builder>() {}.annotatedType());
    assertThat(mutator.toString()).isEqualTo("{Builder.Nullable<Boolean>}");

    OptionalPrimitiveField2.Builder builder = OptionalPrimitiveField2.newBuilder();
  ...
  void testMessageField() {
    ...
    assertThat(builder.getMessageField())
        .isEqualTo(PrimitiveField2.newBuilder().setSomeField(true).build());
    ...
    assertThat(builder.getMessageField())
        .isEqualTo(PrimitiveField2.newBuilder().setSomeField(false).build());
    assertThat(builder.hasMessageField()).isTrue();
  ...
  void testRepeatedMessageField() {
    ...
    assertThat(builder.getMessageFieldList())
        .containsExactly(PrimitiveField2.newBuilder().setSomeField(true).build())
        .inOrder();
    ...
    assertThat(builder.getMessageFieldList())
        .containsExactly(PrimitiveField2.newBuilder().setSomeField(true).build(),
            PrimitiveField2.newBuilder().setSomeField(true).build())
        .inOrder();
    ...
    assertThat(builder.getMessageFieldList())
        .containsExactly(PrimitiveField2.newBuilder().setSomeField(true).build(),
            PrimitiveField2.newBuilder().setSomeField(false).build())
        .inOrder();
  }
  ...
  void testRecursiveMessageField() {
    ...
    assertThat(builder.build())
        .isEqualTo(RecursiveMessageField2.newBuilder()
                       .setSomeField(true)
                       .setMessageField(RecursiveMessageField2.newBuilder())
                       .build());
    ...
    assertThat(builder.build())
        .isEqualTo(RecursiveMessageField2.newBuilder()
                       .setSomeField(true)
                       .setMessageField(RecursiveMessageField2.newBuilder().setMessageField(
  ...
  void testOneOfField2() {
    ...
    assertThat(builder.build())
        .isEqualTo(OneOfField2.newBuilder()
                       .setOtherField(true)
                       .setMessageField(PrimitiveField2.newBuilder().setSomeField(true))
                       .setYetAnotherField(true)
                       .build());
    ...
    assertThat(builder.build())
        .isEqualTo(OneOfField2.newBuilder()
                       .setOtherField(true)
                       .setMessageField(PrimitiveField2.newBuilder().setSomeField(false))
                       .setYetAnotherField(true)
                       .build());
    assertThat(builder.build().hasMessageField()).isTrue();
    ...
    assertThat(builder.build())
        .isEqualTo(OneOfField2.newBuilder().setOtherField(true).setYetAnotherField(true).build());
